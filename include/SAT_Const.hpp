...
const double Rad = pi / 180;                  // Radianes por grado
const double Deg = 180 / pi;                  // Grados por radian
const double Arcs = 3600 * 180 / pi;          // Segundos de arco por radian
...
const double GM_Jupiter = 126712764.800000e9;              // [m^3/s^2]3.14159265358979;
